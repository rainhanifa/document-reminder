...
<div id="main-content">
    ...
    <div id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Daftar Pinjaman Lewat Jatuh Tempo</li>
        </ul>
    </div>
    <!-- END Breadcrumb -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-title">
                    <h3><i class="fa fa-bars"></i>Daftar Pinjaman Lewat Jatuh Tempo</h3>
                    <div class="box-tool">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 style="color: red;"><span class="glyphicon glyphicon-lock"></span> Daftar Dokumen Belum Kembali</h4>
            </div>
